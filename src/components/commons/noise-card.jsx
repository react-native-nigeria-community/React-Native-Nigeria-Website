    ...
    return (
        <div className="monotone-noise px-6 pt-6 pb-3.5 rounded-lg lg:px-0 lg:w-[350px] lg:pb-[51px]">
            ...
            <div className="space-y-2.5 lg:space-y-3.5 lg:ml-7 lg:mr-[65px] lg:mt-4">
                <TypographyComponent
                    as="h3"
                    className="text-mh3! font-semibold leading-none tracking-[-1.8px] lg:text-h4/8! text-secondary"
                >
                    {title}
                </TypographyComponent>
            ...
            <div className="mt-6 lg:mt-20 text-center text-[14px]! leading-[17px] font-medium lg:flex lg:justify-center">
                <ButtonComponent
                    variant="primary"
                    className="text-bg1! lg:text-[18px] lg:leading-[26px]! lg:py-3 lg:px-[38px]"
                >
                    {buttonText}
                </ButtonComponent>
            </div>
