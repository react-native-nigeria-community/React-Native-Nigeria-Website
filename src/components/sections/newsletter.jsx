    ...
    return (
        <section className="w-full lg:flex lg:justify-center py-12">
            <div className="text-center px-4 lg:px-[24px] lg:py-[77px]">
                {/* Heading */}
                <Typography as="h4" variant="h4" className="hidden lg:block">Subscribe to our newsletter</Typography>
                <Typography as="h3" variant="h3" className="block font-semibold lg:hidden">Subscribe to our newsletter</Typography>

                {/* Subheading */}
                <Typography as="p" variant="p" className="mt-2 mb-6 hidden lg:block">
                    Stay updated with events, resources, and the latest in React Native.
                </Typography>
                <Typography as="h6" variant="h6" className="mt-2 mb-6 font-normal lg:hidden">
                    Stay updated with events, resources, and the latest in React Native.
                </Typography>
