export default {
    ...
    labelEmail: "Àdírẹ́ẹ̀sì Ímeèlì",
    labelMessage: "Ìfiránṣẹ́",
    copyRight: "React Native Nigeria. Gbogbo ẹ̀tọ́ ni a dáàbò bò",
    privacyPolicy: "Ìlànà Ìkọ̀kọ̀",
    termsConditions: "Àwọn Òfin & Ìpinnu",
    ...
    firstSection: {
        ...
        learnShareConnect: {
            learnShareConnect1: "Kọ́. Pín. Sopọ̀.",
            learnShareConnect2: "Kọ́. Pín. Sopọ̀. Gbé ìrìnàjò React Native rẹ sókè.",
        },
    },
    ...
    fourthSection: {
        ...
        eventCards: {
            eventCard1: {
                smallText: "ỌRỌ̀ ALÀÀYÈ",
                title: "Bíbẹ̀rẹ̀ iṣẹ́ React Native 2020",
                date: "Oṣù Kẹjọ ọjọ́ 25, 2020",
                time: "10:00 Àárọ̀",
                buttonText: "Wo Ọ̀rọ̀ Alààyè",
                buttonLink: "https://youtu.be/ayCta8DrpD0?si=pvFbRY4NkxWHXj84"
            },
            eventCard2: {
                smallText: "ỌRỌ̀ ALÀÀYÈ",
                title: "Lẹ́yìn Create React App, Kí Ni Tókàn?",
                date: "Oṣù Kẹjọ ọjọ́ 20, 2020",
                time: "10:30 Àárọ̀",
                buttonText: "Wo Ọ̀rọ̀ Alààyè",
    ...
    fifthSection: {
        ...
        exploreReactNative: "Ṣàwárí Àwọn Iṣẹ́ Orísi Ìmọ̀ Ṣíṣí React Native",
        sourceProject: {
            project1: {
                star: "1",
                fork: "0",
            ...
            project2: {
                star: "13",
                fork: "11",
                title: "Rave nípa Flutterwave",
                description: "Gba àwọn ìsanwó láìṣòro nínú ìṣàmúlò React Native rẹ.",
            ...
            project3: {
                ...
                fork: "0",
                title: "Iboju.app",
                description: "Ṣe àwọn àwòrán àkọ́kọ́ ilé-ìtajà ìṣàmúlò láìṣòro.",
            ...
            project4: {
                ...
                description: "Olùkà nọ́mbà alárékérekè dídán fún React Native.",
            ...
            project5: {
                ...
                description: "Yan kí o sì gbé àwọn àwòrán sókè sí Cloudinary kíákíá.",
            ...
            project6: {
                ...
                description: "Ṣe àwọn àwọ̀ tó fẹ́ tàbí tó ṣókùnkùn lẹ́sẹ̀kẹsẹ̀.",
    ...
    faqAccordion: {
        ...
        getUpdates: {
            ...
            slack: {
                text: "dídarapọ̀ mọ́ àwùjọ Slack wa",
                url: "https://reactnativenigeria.slack.com",
            },
            whatsapp: {
                text: "kíkópa nínú ẹgbẹ́ WhatsApp wa",
                url: "https://chat.whatsapp.com/Im8fCMmNaml96AMyOZG4mR",
            },
            andFollowing: "àti títẹ̀lé wa lórí àwọn àwùjọ ìbánisọ̀rọ̀.",
        },
        showcaseProjects: {
            title: "Ṣé mo lè fi àwọn iṣẹ́ React Native mi hàn?",
            guideline: {
                label: "Kọ́ bí o ṣe lè fi àwọn iṣẹ́ rẹ hàn nínú Ìtọ́sọ́nà Ìdásí Àwùjọ wa",
    ...
    eventPage: {
        firstSection: {
            title1: "Kọ́ Pẹ̀lú Àwọn Ìṣẹ̀lẹ̀ React Native",
            title2: "Àwọn Ìṣẹ̀lẹ̀ Àwùjọ React Native",
            slogan: "Wà Ní Ìmúdójúìwọ̀n Pẹ̀lú Àwọn Ìṣẹ̀lẹ̀ Tó Ń Bọ̀ àti Tẹ́lẹ̀ Wa.",
        },
        secondSection: {
        ...
        thirdSection: {
            ...
            event1: {
                title: "Kọ́ Pẹ̀lú React Native",
                date: "Ọjọ́ Ẹtì ọjọ́ 3 Oṣù Kẹwàá 2025",
                time: "6:00 Àṣálẹ́",
                location: "Manchester",
            },
        },
        fourthSection: {
            title: "Àwọn Ìṣẹ̀lẹ̀ Tẹ́lẹ̀ & Àwọn Kókó Pàtàkì",
            event1: {
                title: "Ìkàwẹ́ React Native Nigeria",
                date: "Ọjọ́ 21 Oṣù Kejìlá, 2019",
                time: "10:00 Àárọ̀",
                location: "IBI Center",
                id: "event1",
            },
            event2: {
                title: "React Native Sí Àìlópin Àti Síwájú",
                date: "Ọjọ́ 27 Oṣù Kẹfà 2020",
                time: "10:00 Àárọ̀",
                location: "Lórí Alátagbà",
                id: "event2",
            },
            event3: {
                title: "Àwùjọ React Native Akure",
                date: "Ọjọ́ 18 Oṣù Kejìlá 2021",
                time: "9:00 Àárọ̀",
                location: "Akure",
                id: "event3",
            },
            event4: {
                title: "Ìpàdé React Native Nigeria Abuja 2021",
                date: "Ọjọ́ 29 Oṣù Karùn-ún, 2021",
                time: "09:00 Àárọ̀",
                location: "National Trauma Center",
                id: "event4",
            },
            event5: {
                title: "Ìpàdé React Native Nigeria Abuja 2025",
                date: "Ọjọ́ 20 Oṣù Kẹsàn-án 2025",
                time: "11:00 Àárọ̀",
    ...
    eventDetailsTab: {
        tabs: {
            about: { id: "about", name: "Àwọn Àlàyé & Àpèjúwe" },
            speakers: { id: "speakers", name: "Àwọn Agbọ́rọ̀sọ" },
            photos: { id: "photos", name: "Àwọn Àwòrán" },
            videos: { id: "videos", name: "Àwọn Fídíò" },
            gallery: { id: "gallery", name: "Ilé-ìṣèwò Àwòrán" },
        },
        summaryTitle: "Àkójọpọ̀ Ìṣẹ̀lẹ̀",
        date: "Ọjọ́",
        time: "Àkókò",
        location: "Ibùdó",
        aboutEvent: "Nípa Ìṣẹ̀lẹ̀ Náà",
