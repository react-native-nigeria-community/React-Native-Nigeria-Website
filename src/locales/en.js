export default {
    ...
    secondSection: {
        ...
        readyToBuildRna: {
            ...
            description: "Launch your next React Native project with us, gain insights, support, and tools from a vibrant developer community.",
        },
    },
    ...
    sixthSection: {
        contributeCommunity: {
            ...
            description: "Share your knowledge, inspire others, and help grow the React Native ecosystem.",
        },
        communityCard: {
            communityCard1: {
                title: "Write for Us",
...
newsletterPage: {
  ...
  description: "Read past React Native Nigeria newsletters and community updates.",
