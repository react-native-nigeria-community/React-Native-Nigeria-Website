  ...
  return (
    <>
      ...
      <section className={"py-12 px-6 lg:bg-bg1"}>
        <div
          className={
            "text-center lg:text-left lg:flex lg:justify-center lg:mx-auto"
          }
        >
          <div className={"lg:grid lg:grid-cols-2 lg:grid-rows-2"}>
            <p
              className={
                "text-[40px] leading-none tracking-[-2px] font-medium lg:w-[621px] lg:content-end lg:pb-6 lg:text-white"
              }
            >
            ...
            <img
              ...
              alt={"about-image"}
              className={
                "h-[328px] lg:h-[636px] mx-auto lg:col-span-1 lg:row-span-2 lg:pl-[104px]"
              }
            />
            <TypographyComponent
              as={"p"}
              variant={"p"}
              className={
                "font-normal leading-8 tracking-[0.12px] lg:w-[621px] lg:text-white"
              }
            >
      ...
      <section className={"bg-bg2 silver-wave lg:py-[120px] lg:px-[153px]"}>
        <div className={"px-6 pt-12 pb-4 text-center"}>
          <TypographyComponent
            ...
            variant={"p"}
            className={
              "leading-8 tracking-[-0.21px] font-normal text-secondary lg:text-h3 lg:leading-12 lg:tracking-normal"
            }
          >
      ...
      <section className={"pt-12 lg:pt-[100px]"}>
        <div className={"text-center space-y-2.5 pb-6 lg:w-[521px] lg:mx-auto"}>
          ...
          <TypographyComponent
            ...
            variant={"h3"}
            className={
              "text-mh3! text-bg1! leading-none! tracking-normal! lg:text-h2! lg:tracking-[-1.2px]! lg:font-normal!"
            }
          >
