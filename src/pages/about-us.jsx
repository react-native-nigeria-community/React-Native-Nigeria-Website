        ...
        <>
            ...
            <section className={"py-12 px-6 lg:bg-bg1"}>
                <div className={"text-center lg:text-left lg:flex lg:justify-center lg:mx-auto"}>
                    <div className={"lg:grid lg:grid-cols-2 lg:grid-rows-2"}>
                        <p className={"text-[40px] leading-none tracking-[-2px] font-medium lg:w-[621px] lg:content-end lg:pb-6 lg:text-white"}>
                            {t.aboutPage.heroText1}
                        </p>
                        <img src={AboutJPG} alt={"about-image"} className={"h-[328px] lg:h-[636px] mx-auto lg:col-span-1 lg:row-span-2 lg:pl-[104px]"} />
                        <TypographyComponent as={"p"} variant={"p"} className={"font-normal leading-8 tracking-[0.12px] lg:w-[621px] lg:text-white"}>
                            {t.aboutPage.heroText2}
                        </TypographyComponent>
                    </div>
                </div>
            </section>
            ...
            <section className={"pt-12 lg:pt-[100px]"}>
                <div className={"text-center space-y-2.5 pb-6 lg:w-[521px] lg:mx-auto"}>
                    <TypographyComponent as={"h6"} variant={"h6"} className={"text-accent! font-normal lg:tracking-[1.63px]"}>
                        {t.aboutPage.faq}
                    </TypographyComponent>
                    <TypographyComponent as={"h3"} variant={"h3"} className={"text-mh3! text-bg1! leading-none! tracking-normal! lg:text-h2! lg:tracking-[-1.2px]! lg:font-normal!"}>
                        {t.aboutPage.faqTitle}
                    </TypographyComponent>
                </div>
                <div className={"lg:pt-[115px]"}>
                    <AccordionComponent items={translatedAccordions} allowMultiple={false} />
                </div>
            </section>
        </>
    );
