            ...
            <section className={"py-12 px-6 lg:bg-bg1"}>
                <div className={"text-center lg:text-left lg:flex lg:justify-center lg:mx-auto"}>
                    <div className={"lg:grid lg:grid-cols-2 lg:grid-rows-2"}>
                        ...
                        <img src={FemaleAvatarPNG} alt={"avatar-icon"} className={"h-[328px] md:h-[636px] mx-auto lg:col-span-1 lg:row-span-2 lg:pl-[104px]"} />
                        <TypographyComponent as={"p"} variant={"p"} className={"text-secondary/85 font-normal leading-8 tracking-[0.12px] lg:w-[621px] lg:text-white"}>
